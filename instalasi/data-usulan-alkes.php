...
$usulan_alkes=mysqli_query($koneksi,"SELECT * FROM usulan_alkes inner join users on usulan_alkes.id_user=users.id_user where usulan_alkes.id_user='$id_user'")or die(mysql_error());
?>  
  <div class="main-panel">
      <div class="content">
        <div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Data Usulan Alat Kesehatan</h4>
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="master-alkes.php?data">Alat Kesehatan</a>
              </li>
            </ul>
          </div>
            ...
            <div class="card-body ">
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers">
                    <p class="card-category">Jumlah Usulan Alat Kesehatan</p>
                    <h4 class="card-title"><?= mysqli_num_rows($usulan_alkes); ?></h4>
                  </div>
                </div>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="multi-filter-select" class="display table table-striped table-hover" >
                      ...
                      <?php
                          $no=1;
                          while ($a = mysqli_fetch_array($usulan_alkes)) :?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $a['nama'] ?></td>
                          <td><?php echo $a['anggaran'] ?></td>
                          <td><?php echo $a['tgl_usulan_alkes'] ?></td>
                          <td><?php if ($a['posisi_usulan_alkes'] == 0) {
                            echo "Pengajuan";
                          } elseif($a['posisi_usulan_alkes'] == 1) {
                            echo "Kasi";
                          }  ?></td>
                          <td>
                            <a class="btn btn-icon btn-info" href="list-alkes.php?id_usulan_alkes=<?php echo $a['id_usulan_alkes']; ?>"  title='List Data'><i class="fa fa-edit"></i></a>
