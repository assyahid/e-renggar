              ...
              while($d=mysqli_fetch_array($usulan_barang)){ 
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='controller/v1.php?hapusmerek&id_merek_barang=<?php echo $d['id_merek_barang']; ?>&id_usulan=<?php echo $d['id_usulan']; ?>&id_usulan_barang=<?php echo $d['id_usulan_barang']; ?>' }" class="btn btn-icon btn-round btn-danger"> <i class="fa fa-trash"></i></a>
                        <?php }  ?>
                  </td>
                </tr> 
