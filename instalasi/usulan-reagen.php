		...
		<div class="page-inner">
			...
			<div class="row">
          	...
          	<form action="" method="post">
          		<table hidden="">
      			<tr>
      				<td><input type="text" name="id_usulan" class="form-control" value="<?php echo $_GET['id_usulan']; ?>"></td>
      			</tr>
                <tr>
                  <td><input type="text" name="id_user" class="form-control" value="<?php echo $_SESSION['id_user']; ?>"></td>
                </tr>
      			<tr>
      				<td><input type="date" name="tgl_usulan_reagen" class="form-control" value="<?php echo date("Y-m-d") ?>"></td>
      			</tr>
      			
          		</table>
          		<button style="margin-bottom:20px" type="submit" class="btn btn-sm btn-primary" name="transaksi">
...
$tgl_usulan_reagen = $_POST['tgl_usualan_reagen'];

$query = "INSERT INTO usulan_reagen 
  (id_usulan_reagen,
  id_usulan, 
  id_user, 
  tgl_usulan_reagen
...
echo '<script type="text/javascript">
    //
    window.location="list-reagen.php?data";
    //
