    ...
    <div class="page-inner">
      <div class="page-header">
        ...
        <ul class="breadcrumbs">
          <a href="alkes.php?id_usulan=<?=$_GET['id_usulan'];?>" class="btn btn-info">Kembali ke menu usulan Pengolah Data</a>
        </ul>
      </div>
<div class="row">
  <div class="col-md-12">
              ...
              while($d=mysqli_fetch_array($usulan_barang)){ 
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-icon btn-round btn-primary" data-toggle="modal" data-target="#exampleEdit_<?php echo $d['id_merek_barang']; ?>">
                    ...
                    <a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='controller/v1.php?hapusmerekpdata&id_merek_barang=<?php echo $d['id_merek_barang']; ?>&id_usulan=<?php echo $d['id_usulan']; ?>&id_usulan_barang=<?php echo $d['id_usulan_barang']; ?>' }" class="btn btn-icon btn-round btn-danger"> <i class="fa fa-trash"></i></a></td>
                </tr> 
