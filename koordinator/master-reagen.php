...
$commodities=mysqli_query($koneksi,"SELECT * FROM commodities where group_id='14'")or die(mysql_error());
?>  
  <div class="main-panel">
      <div class="content">
        <div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Master Data Reagen</h4>
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="#">Data Reagen</a>
              </li>
              <li class="separator">
                <i class="flaticon-right-arrow"></i>
              </li>
              <li class="nav-item">
                <a href="master-alkes.php?data">Reagen</a>
              </li>
            </ul>
          </div>
            ...
            <div class="card-body ">
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers">
                    <p class="card-category">Jumlah Reagen</p>
