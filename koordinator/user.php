								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
									        $query = mysqli_query($koneksi,"SELECT * FROM users where id_user='$_SESSION[id_user]'");
									        $no=1;
									        while ($a = mysqli_fetch_array($query)) :?>
												<tr>
													...
													<td><?php $q=mysqli_query($koneksi,"SELECT * FROM users where id_user='$a[atasan]' "); $x=mysqli_fetch_array($q); echo $x['nama']; ?></td>
