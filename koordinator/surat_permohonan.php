								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
											...
											<tbody>
											<?php
									        $sql = "SELECT * FROM surat_permohonan where status_surat in ('Telah divalidasi Kasubbag Administrasi Umum','Telah divalidasi Koordinator Tata Usaha')";
...
<form method="POST" action="">
	<table class="table">
		...
		<?php if ($d['status_surat']=='Telah divalidasi Koordinator Tata Usaha') {
												# code...
		} else { ?>
		<tr>
			<td>Validasi</td>
			<td><select class="form-control" name="status_surat" readonly>
				...
				<option value="Telah divalidasi Koordinator Tata Usaha">Validasi</option>
