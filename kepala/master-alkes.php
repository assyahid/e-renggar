...
$barang=mysqli_query($koneksi,"SELECT * FROM barang where kategori='Alat Kesehatan'")or die(mysql_error());
?>  
  <div class="main-panel">
      <div class="content">
        <div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Master Data Alat Kesehatan</h4>
            ...
            <div class="card-body ">
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers">
                    <p class="card-category">Jumlah Alat Kesehatan</p>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="multi-filter-select" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                      <?php
                          $sql = "SELECT * FROM barang where kategori='Alat Kesehatan'";
