...
$reagen=mysqli_query($koneksi,"SELECT * FROM reagen inner join commodities on reagen.id_barang=commodities.id inner join users on reagen.id_user=users.id_user")or die(mysql_error());
										...
										<table id="multi-filter-select" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												while($d=mysqli_fetch_array($reagen)){ 
													...
													<td>
															<?php if ($d['status_reagen']=="divalidasi oleh Koordinator Tata Usaha") { ?>
