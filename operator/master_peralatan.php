...
$pegawai=mysqli_query($koneksi,"SELECT * FROM peralatan inner join users on peralatan.id_user=users.id_user")or die(mysql_error());
	...
	<div class="content">
		<div class="page-inner">
			<div class="page-header">
				<h4 class="page-title">Master Data Peralatan</h4>
						...
						<div class="card-body ">
							<div class="row align-items-center">
								...
								<div class="col col-stats ml-3 ml-sm-0">
									<div class="numbers">
										<p class="card-category">Jumlah Peralatan di instalasi anda</p>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">Master data peralatan <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal" style="float: right;">
								<span class="fas fa-plus"></span> Input Data Peralatan</button></h4>
							</div>
							<div class="card-body">
						...
						<div class="modal-body">
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									...
									<input type="text" name="nama" class="form-control" id="email2" placeholder="Input nama peralatan">
								</div>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									<label for="email2">Jenis</label>
									<input type="text" name="jenis" class="form-control" id="email2" placeholder="Input jenis peralatan">
								</div>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									<label for="email2">Satuan</label>
									<input type="text" name="satuan" class="form-control" id="email2" placeholder="Input satuan">
								</div>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									<label for="email2">Jumlah</label>
									<input type="number" name="jumlah" class="form-control" id="email2" placeholder="Input jumlah">
								</div>
							</div>
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									<label for="email2">Kondisi</label>
									<input type="text" name="kondisi" class="form-control" id="email2" placeholder="Input kondisi">
								</div>
							</div>
						</div>
						<div class="modal-footer">
							<input type="submit" name="submit" class="btn btn-primary" value="Tambah Peralatan">
