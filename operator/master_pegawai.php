...
$pegawai=mysqli_query($koneksi,"SELECT * FROM pegawai inner join users on pegawai.id_user=users.id_user")or die(mysql_error());
				...
				<div class="modal-content">
					...
					<form method="POST" action="controller/v1.php">
						<div class="modal-body">
							...
							<div class="col-md-12 col-lg-12">
								<div class="form-group">
									<label for="email2">Users</label>
									<select name="id_user" class="form-control" id="defaultSelect">
