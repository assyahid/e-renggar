												...
												while ($a = mysqli_fetch_array($query)) :?>
													<tr>
														...
														<?php }  elseif ($a['status_surat']=="Telah divalidasi Kepala") { ?>
															...
															<?php if(($a['status_surat']=="Telah divalidasi Kepala")){ ?>
																<a class="blue btn btn-primary" href="list_proker.php?id_surat_permohonan=<?= $a['id_surat_permohonan']; ?>"  title='Validasi'>
																	<i class="ace-icon fa fa-search-plus bigger-130"></i>Program Kerja
																</a>
															<?php } ?>
										...
										<table class="table">
											...
											<tr>
												...
												<td><select class="form-control" name="status_surat" readonly>
													...
													<option value="Telah divalidasi Kasubbag Administrasi Umum">Validasi</option>
