...
$barang=mysqli_query($koneksi,"SELECT * FROM barang where kategori='Pengolah Data'")or die(mysql_error());
?>  
  <div class="main-panel">
      <div class="content">
        <div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Master Data Pengolah Data</h4>
            <ul class="breadcrumbs">
              ...
              <li class="nav-item">
                <a href="master-alkes.php?data">Pengolah Data</a>
              </li>
            </ul>
          </div>
            ...
            <div class="card-body ">
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers">
                    <p class="card-category">Jumlah Pengolah Data</p>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="multi-filter-select" class="display table table-striped table-hover" >
                      ...
                      <tbody>
                      <?php
                          $sql = "SELECT * FROM barang where kategori='Pengolah Data'";
