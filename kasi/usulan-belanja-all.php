...
$usulan=mysqli_query($koneksi,"SELECT * FROM usulan INNER JOIN users ON users.id_user = usulan.id_user WHERE atasan='$_SESSION[id_user]' AND status != 'pengajuan' ORDER BY usulan.id_usulan DESC ")or die(mysql_error());
